...
const preLoadedObjects = [
    ...
    },
    {
        ...
        description: "IDseq is an open-source, cloud-based platform developed for metagenomic next-generation sequencing (mNGS) analysis. IDseq has a specific scope focused on pathogen detection, antibiotic resistance detection and infection control.",
        url: "https://czid.org/"
    },
    {
        id: "pipeline13",
